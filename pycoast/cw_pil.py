...
class ContourWriter(ContourWriterBase):
    ...
    def _draw_polygon(self, draw, coordinates, **kwargs):
        """Draw polygon
        """
        outline=kwargs.get('outline', (255, 255, 255))
        ...
        if width == 1:
            ...
            draw.line(coordinates, width=int(width), fill=outline)
    ...
    def _draw_line(self, draw, coordinates, **kwargs):
        """Draw line
        """
        draw.line(coordinates, fill=kwargs['outline'], width=int(kwargs.get('width', 1)))
    ...
    def add_line(self, image, area_def, lonlats,
                 fill=None, outline='white', x_offset=0, y_offset=0, width=1):
    ...
    def add_grid(self, image, area_def, Dlonlat, dlonlat,
                 ...
                 lon_placement='tb', lat_placement='lr', width=None):
        ...
        self._add_grid(image, area_def, Dlon, Dlat, dlon, dlat, font=font,
                       ...
                       lon_placement=lon_placement, lat_placement=lat_placement, width=width)
    ...
    def add_borders(self, image, area_def, resolution='c', level=1,
                    outline='white', x_offset=0, y_offset=0, width=1):
    ...
    def add_rivers_to_file(self, filename, area_def, resolution='c', level=1,
        ...
        self.add_rivers(image, area_def, resolution=resolution, level=level,
                        outline=outline, x_offset=x_offset, y_offset=y_offset, width=width)
        image.save(filename)
